...
public class RobotContainer 
{
  ...
  private void configureAutoCommands()
  {
    ...
    NamedCommands.registerCommand("AimAuto", new DriveWithTargetAngle(m_Drivetrain, () -> 0.0, () -> 0.0, () -> m_Drivetrain.getRotationToSpeaker()));
  ...
  private void configureBindings() 
  {
    ...
    (
      new ParallelCommandGroup(
        ...
        new DriveWithTargetAngle(m_Drivetrain, m_PrimaryControllerLeftY, m_PrimaryControllerLeftX, () -> m_Drivetrain.getRotationToSpeaker())
      ),
      new LowShot(m_Orchestrator),
