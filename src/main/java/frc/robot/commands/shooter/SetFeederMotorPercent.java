...
public class SetFeederMotorPercent extends Command
{
  Shooter m_Shooter;
  double m_Percent;
  ...
  */
  public SetFeederMotorPercent(Shooter shooter, double percent)
  {
  ...
  {
    m_Shooter.setShooterMotorPercent(MOTOR.FEEDER_MOTOR, this.m_Percent);
  }
